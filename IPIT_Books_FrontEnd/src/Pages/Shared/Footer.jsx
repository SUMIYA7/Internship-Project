...
const Footer = () => {
    return (
        <div className="mt-52 a">
            <footer className="footer flex justify-around p-10 border-t-2 border-white">
                <nav>
                ...
                <nav>
                    ...
                    <Link target="_blank" to='https://www.ictexpertbd.com/'  className="link link-hover">ICT Expert</Link>
                    <Link target="_blank" to='https://ipitltd.com/'  className="link link-hover">IPIT Limited</Link>
                </nav>
                <nav>
            ...
            <footer className="footer items-center p-4 a bg-emerald-50">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Copyright © 2024 - All right reserved @ IPIT Limited</p>
                </aside>
